...
export default function LiveQuestion({
  ...
  // Use refs to track the latest values in timer callback
  ...
  const submitAnswer = (selectedIdx) => {
    ...
    if (lastSubmittedRef.current !== selectedIdx) {
      ...
      lastSubmittedRef.current = selectedIdx;
    }
  };
    ...
    const interval = setInterval(() => {
      setTimer((prev) => {
        if (prev <= 1) {
          ...
          // Use ref to get the latest selected value
          const currentSelected = selectedRef.current;
          const currentLastSubmitted = lastSubmittedRef.current;

          // Only submit if something was selected but not yet submitted
          if (currentSelected !== null && currentLastSubmitted !== currentSelected) {
            const selectedAnswer = question.options[currentSelected];
            console.log("Timer expired - submitting final answer:", selectedAnswer);
            ...
            setLastSubmittedAnswer(currentSelected);
            lastSubmittedRef.current = currentSelected;
          } else if (currentSelected === null) {
            console.log("Timer expired - no answer selected");
          }
  ...
  }, [question, studentId, studentName, onAnswer]);
              ...
              <div className="bg-black text-white p-6 rounded-t-xl">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div
                      className={`w-3 h-3 rounded-full ${timer > 5
                        ? "bg-white"
                        : timer > 2
                          ? "bg-gray-400"
                          : "bg-gray-600"
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {question.options.map((opt, idx) => (
                    <button
                      key={idx}
                      className={`w-full p-4 rounded-lg border-2 text-left transition-all duration-200 transform hover:scale-[1.02] ${selected === idx
                    ...
                    >
                      <div className="flex items-center">
                        <span
                          className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-3 text-sm font-bold ${selected === idx
                ...
                <div className="text-center">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Your test session has been completed and all responses have been
                      recorded. You can review your performance and results in the
                      dashboard.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-xs text-gray-500">
                      Performance metrics and detailed analysis can be viewed in your
                      dashboard
                    </p>
                  </div>
