                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className={`p-2 rounded-lg ${
                            userType === type ? "bg-gray-800 dark:bg-gray-200 text-white dark:text-black" : "bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-300"
                          }`}>
                            {icon}
                          </div>
                          <div>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-10 py-3 rounded-lg border-2 focus:outline-none transition-all duration-200 bg-white dark:bg-gray-700 text-black dark:text-white placeholder-gray-500 dark:placeholder-gray-400 ${
                        email === ""
